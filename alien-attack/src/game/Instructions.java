...
public class Instructions {
    ...
    public void render(Graphics g) {
        ...
        //Instructions
        g.setFont(fnt1);
        g.drawString("Use the left and right arrow keys to move.", xPos, yStart);
        g.drawString("Press the spacebar to shoot your bullets at the UFOs above.", xPos, yStart + spacing);
